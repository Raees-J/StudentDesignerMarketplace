...
class CustomerFactoryTest {
    ...
    void createCustomer_ValidPaymentMethod() {
        ...
        Customer customer1 = CustomerFactory.createCustomer("Card", 150.75);
        ...
        Customer customer2 = CustomerFactory.createCustomer("Cash", 50.00);
        ...
        Customer customer3 = CustomerFactory.createCustomer("Online", 299.99);
    ...
    void createCustomer_InvalidPaymentMethod() {
        ...
        IllegalArgumentException exception = assertThrows(IllegalArgumentException.class, () -> {
            CustomerFactory.createCustomer("Bitcoin", 100.00);
        });
        ...
        IllegalArgumentException exception2 = assertThrows(IllegalArgumentException.class, () -> {
            CustomerFactory.createCustomer(null, 75.00);
        });
        ...
        IllegalArgumentException exception3 = assertThrows(IllegalArgumentException.class, () -> {
            CustomerFactory.createCustomer("", 200.00);
        });
